...
from PyMinitel.minitel.constantes import (SS2, SEP, ESC, CSI, PRO1, PRO2, PRO3, MIXTE1,
...
#TODO : Temporaire tant que je n'ai pas fini ma classe PyMinitel
sys.path.append("C:\\Users\\emili\\PycharmProjects\\Howitzer\\PyMinitel")
from PyMinitel.minitel.Minitel import Minitel
#try :
#except ImportError as e:
#    subprocess.check_call([sys.executable, "-m", "pip", "install", "git+https://github.com/Zigazou/PyMinitel/minitel"])
...
if __name__ == '__main__':
    ...
    howitzer.configurer_clavier(etendu=True, minuscule=True)
    howitzer.definir_mode(rouleau=True)
    test_route(howitzer)
